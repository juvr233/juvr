                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="male">Male (阳 - Yang)</option>
                      <option value="female">Female (阴 - Yin)</option>
                      <option value="other">Other (和 - Harmony)</option>
                    </select>
                    <p className="text-[#C0A573]/70 text-sm mt-2 italic">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                  ...
                  <div>
                    <p className="text-[#F0F0F0] font-semibold capitalize">
                      {state.birthInfo.gender === 'male' ? '阳 Yang' : state.birthInfo.gender === 'female' ? '阴 Yin' : '和 Harmony'}
                    </p>
